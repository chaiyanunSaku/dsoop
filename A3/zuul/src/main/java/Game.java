...
public class Game 
{
    ...
    {
        Room outside, theater, pub, lab, office, cafe, restroom, upstairs, basement;
        ...
        Room teleport = new Room(""); // no description needed

        // Add all rooms to the list before setting exits
        // does not include Room "teleport"
        ...
        restroom.setExit("magic", teleport);
        ...
        basement.setExit("magic", teleport);
    ...
    private void goRoom(Command command)
    {
        ...
        if (nextRoom == null) {
            ...
            // Only teleport if player is using "magic" and it's a valid exit
            if (direction.equals("magic")) {
                previousRoom = currentRoom;
                currentRoom = getRandomRoom();
                System.out.println("Dizzy dizzy... you've been teleported to a random place!");
            } else {
                previousRoom = currentRoom;
